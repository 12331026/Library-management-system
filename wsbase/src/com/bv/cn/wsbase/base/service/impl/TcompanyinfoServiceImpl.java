...
@Service
@Transactional
public class TcompanyinfoServiceImpl extends BvBaseServiveImpl<Tcompanyinfo> implements
	TcompanyinfoService<Tcompanyinfo> {
		
	public Class<?> getEntityClass() {
		return Tcompanyinfo.class;
	}
	
	private TcompanyinfoDAO<Tcompanyinfo> tcompanyinfoDAO;
	
	@Autowired
	public void setTcompanyinfoDAO(TcompanyinfoDAO<Tcompanyinfo> dao) {
		this.tcompanyinfoDAO = dao;
