...
@Service
@Transactional
public class TarticleServiceImpl extends BvBaseServiveImpl<Tarticle> implements
	TarticleService<Tarticle> {
		
	public Class<?> getEntityClass() {
		return Tarticle.class;
	}
	
	private TarticleDAO<Tarticle> tarticleDAO;
	
	@Autowired
	public void setTarticleDAO(TarticleDAO<Tarticle> dao) {
		this.tarticleDAO = dao;
