...
@Service
@Transactional
public class TshowareaServiceImpl extends BvBaseServiveImpl<Tshowarea> implements
	TshowareaService<Tshowarea> {
		
	public Class<?> getEntityClass() {
		return Tshowarea.class;
	}
	
	private TshowareaDAO<Tshowarea> tshowareaDAO;
	
	@Autowired
	public void setTshowareaDAO(TshowareaDAO<Tshowarea> dao) {
		this.tshowareaDAO = dao;
