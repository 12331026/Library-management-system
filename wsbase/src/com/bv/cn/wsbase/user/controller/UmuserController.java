...
@Controller
public class UmuserController<Umuser> extends BvBaseController<Umuser> {
	
	public void setListPagePath() {
		super.setListPagePath("wsbase/umuser/umuser_list");
	}

	public void setListChildPagePath() {
		super.setListChildPagePath("wsbase/umuser/umuser_list_child");
	}

	public void setEditPagePath() {
		super.setEditPagePath("wsbase/umuser/umuser_edit");
	}

	public void setFormPagePath() {
		super.setFormPagePath("wsbase/umuser/umuser_form");
	}
