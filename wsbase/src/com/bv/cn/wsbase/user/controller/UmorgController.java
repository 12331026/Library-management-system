...
@Controller
public class UmorgController<Umorg> extends BvBaseController<Umorg> {
	
	public void setListPagePath() {
		super.setListPagePath("wsbase/umorg/umorg_list");
	}

	public void setListChildPagePath() {
		super.setListChildPagePath("wsbase/umorg/umorg_list_child");
	}

	public void setEditPagePath() {
		super.setEditPagePath("wsbase/umorg/umorg_edit");
	}

	public void setFormPagePath() {
		super.setFormPagePath("wsbase/umorg/umorg_form");
	}
