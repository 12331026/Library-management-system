...
@Controller
public class UmuserroleController<Umuserrole> extends BvBaseController<Umuserrole> {
	
	public void setListPagePath() {
		super.setListPagePath("wsbase/umuserrole/umuserrole_list");
	}

	public void setListChildPagePath() {
		super.setListChildPagePath("wsbase/umuserrole/umuserrole_list_child");
	}

	public void setEditPagePath() {
		super.setEditPagePath("wsbase/umuserrole/umuserrole_edit");
	}

	public void setFormPagePath() {
		super.setFormPagePath("wsbase/umuserrole/umuserrole_form");
	}
