...
@Service(value="umorgService")
@Transactional
public class UmorgServiceImpl extends BvBaseServiveImpl<Umorg> implements
	UmorgService<Umorg> {
	...
	private UmorgDAO<Umorg> umorgDAO;
	
	@Autowired
	public void setUmorgDAO(UmorgDAO<Umorg> dao) {
		this.umorgDAO = dao;
